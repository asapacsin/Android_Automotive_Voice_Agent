...
class AndroidMicrophonePort(
    ...
    /**
     * After 小诺 finishes a reply the mic reopens, but the room still holds her voice for a few
     * hundred milliseconds. That residual was measured (2026-09-20) to become a new user turn and
     * a phantom 「没听清」. Drop frames and reset the uplink onset for [durationMs] after reopen.
     */
    fun holdPostSpeechEcho(durationMs: Long) {
        ...
        interrupted = false // next dropped frame may re-note the interruption
