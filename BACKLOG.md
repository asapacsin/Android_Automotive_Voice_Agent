...
| B-004 | Amap coexistence by **voice policy** and generic `ActionExecutor` with a mock | 2026-09-16 | **Revised by v2** — its two open conflicts are resolved (§16 keeps Baidu E2E; §19 supplies the Amap-speaking signal); policy now keyed on `NavigationState`; carried under SPEC-005 Phases 5–6 | [SPEC-003](SPECS/SPEC-003-amap-coexistence-voice-policy.md) → SPEC-005 |
