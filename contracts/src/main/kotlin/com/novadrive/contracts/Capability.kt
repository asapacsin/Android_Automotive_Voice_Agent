...
object ProductCapabilities : CapabilityCatalog {
    private val backing = MapCapabilityCatalog(
        listOf(
            ...
            rec("navigation.driving_presentation", null, true),
            rec("navigation.route_preview", null, true),
            rec("navigation.lock_car_tracking", null, true),
            rec("navigation.heading_up_map", null, true),
            rec("navigation.traffic_presentation", null, true),
            rec("navigation.speed_hud", null, true),
            rec("navigation.maneuver_guidance", null, true),
            rec("navigation.lane_junction_presentation", null, true),
            ...
            rec("speech.post_speech_echo_protection", null, true),
            rec("speech.action_claim_truthfulness", null, true),
