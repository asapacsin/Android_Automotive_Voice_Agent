...
| --- | --- | --- | --- | --- | --- | --- |
| APPS-001 | apps | open_app reaches a real app | AUTONOMOUS | STALE | no | 2026-09-20: open_app settings -> Accepted, maps -> Accepted |
...
| CALL-NOSIM-001 | calling | A car that cannot call says so | AUTONOMOUS | STALE | yes | 2026-09-20 on 2391ff70, gsm.sim.state=ABSENT,ABSENT |
...
| CLIMATE-IMPLICIT-001 | climate | 有点热 produces a real adjustment | AUTONOMOUS | STALE | yes | 2026-09-20: 20/20 suite, after isControlRequest learned to ask ContextResolver |
| CLIMATE-OFF-001 | climate | 关闭空调 turns it off | AUTONOMOUS | STALE | yes | 2026-09-20: 20/20 suite |
| CLIMATE-SET-001 | climate | An explicit temperature is set | AUTONOMOUS | STALE | yes | 2026-09-20: 20/20 suite |
| CTX-AMBIG-001 | dialogue_context | 再低一点 with no history asks which | AUTONOMOUS | STALE | yes | 2026-09-20: 「您是指温度还是风量呢？」 |
| CTX-CHAIN-001 | dialogue_context | 再凉一点 continues the previous adjustment | AUTONOMOUS | STALE | yes | 2026-09-20: 20/20 suite |
| HELP-001 | dialogue_context | 「你能做什么」 / 「你能干啥」 gets a short capability answer | AUTONOMOUS | STALE | yes | 2026-09-22 device 2391ff70: transcript=你能干啥 → 导航+音乐+空调+地图/设置; TURN_RELEASE reason=capab… |
...
| PROCDEATH-001 | lifecycle | The app survives process death | AUTONOMOUS | STALE | yes | 2026-09-20: pid 13783 killed once the app was genuinely backgrounded (am kill only reap… |
| MUSIC-NAMED-001 | media | A named song is refused, not substituted | AUTONOMOUS | STALE | yes | 2026-09-20: 20/20 suite |
| MUSIC-PLAY-001 | media | 播放音乐 plays the bundled track | AUTONOMOUS | STALE | no | 2026-09-20: 20/20 suite |
...
| NAV-CANCEL-001 | navigation | 算了 really cancels | AUTONOMOUS | STALE | yes | 2026-09-20: nav_flow_cancelled |
| NAV-CORRECT-001 | navigation | A mid-flow destination change replaces the list | AUTONOMOUS | STALE | no | 2026-09-20: 20/20 suite |
...
| NAV-E2E-ARRIVAL-001 | navigation | Navigation reaches the destination and terminates by arrival | AUTONOMOUS | STALE | yes | video:D:/桌面/android_doc/nav_e2e_arrival_2026-09-21/nav_e2e_arrival.mp4 |
| NAV-MID-ROUTE-001 | navigation | Mid-route navigation baseline without countdown entitlement | AUTONOMOUS | STALE | yes | 2026-09-21: nav_traffic_countdown status=BLOCKED_EXTERNAL_AMAP_ENTITLEMENT |
| NAV-PICK-001 | navigation | 第二个 picks from the on-screen list | AUTONOMOUS | STALE | yes | 2026-09-20: 20/20 suite |
| NAV-SEARCH-001 | navigation | A destination produces candidates and does not start navigating | AUTONOMOUS | STALE | yes | 2026-09-20: 20/20 suite |
| NAV-SIM-QA-001 | navigation | Reusable navigation screen-recording movie for QA | AUTONOMOUS | STALE | no | artifact:D:/桌面/android_doc/nav_qa_to_shizimen.mp4 size=78483175 bytes at 2026-09-21 10:31 |
...
| NAV-UI-002 | navigation | During GPS navigation the vehicle stays in lock-car tracking | AUTONOMOUS | STALE | yes | artifact:D:/桌面/android_doc/nav_ui_desk_2026-09-21/t0_after_start.png |
| NAV-UI-003 | navigation | Vehicle heading rotates the navigation map | AUTONOMOUS | STALE | yes | artifact:D:/桌面/android_doc/nav_ui_desk_2026-09-21/t0_after_start.png compass 北 at left |
| NAV-UI-004 | navigation | Active route shows traffic-state colouring when Amap supplies it | AUTONOMOUS | STALE | yes | log:NovaVoice/nav_traffic_status_update |
| NAV-UI-005 | navigation | Next-maneuver guidance is visible | AUTONOMOUS | STALE | yes | log:NovaVoice/nav_maneuver iconType remainMeters |
| NAV-UI-006 | navigation | Lane or junction enlarge appears when Amap supplies it | AUTONOMOUS | STALE | no | log:NovaVoice/nav_lane_info shown=true |
| NAV-UI-007 | navigation | Overview then return restores vehicle tracking | AUTONOMOUS | STALE | yes | log:NovaVoice/debug_tool tool=nav_overview result=overview=true |
...
| PERM-DENY-001 | permissions | A revoked microphone permission fails honestly | AUTONOMOUS | STALE | yes | 2026-09-20: pm revoke RECORD_AUDIO -> voice start returns MicPermissionMissing, wake lo… |
| SUITE-SCENARIO-001 | regression | The live scenario suite | AUTONOMOUS | STALE | yes | 2026-09-20: 20/20, exit 0 |
...
| LIFECYCLE-ERROR-001 | reliability | A dead session stops showing that it is listening | AUTONOMOUS | STALE | yes | 2026-09-20: verified by reproducing the rejection, then reverting it |
| NET-RECOVER-001 | reliability | A cut connection recovers without the driver noticing | AUTONOMOUS | STALE | yes | 2026-09-20: tool=control_climate after the socket was cancelled |
| PLACE-NAV-001 | saved_places | 回家 resolves from the saved place, not a POI search | AUTONOMOUS | STALE | no | 2026-09-20: 4/5 - the ASR misses the two-character utterance about once in five, and th… |
| PLACE-SAVE-001 | saved_places | An address is resolved before it is stored | AUTONOMOUS | STALE | no | 2026-09-19: place=珠海站 |
| PLACE-UNSET-001 | saved_places | An unset home is admitted, not guessed | AUTONOMOUS | STALE | yes | 2026-09-19 device |
...
| TRUTH-BAIT-001 | truthfulness | An explicit request to lie is not obeyed | AUTONOMOUS | STALE | yes | 2026-09-20: 20/20 suite |
...
| TRUTH-MEDIA-001 | truthfulness | A song we cannot play is refused even when misheard | AUTONOMOUS | STALE | yes | 2026-09-20: 3/3 then 5/5 after the fix; before it, the bundled track played |
| TRUTH-MISHEARD-001 | truthfulness | A misheard driver is not told the car acted | AUTONOMOUS | STALE | yes | 2026-09-19: 「返屋企啦」 -> 「发诺克拉。」 -> correction, not a claim |
| TRUTH-WEATHER-001 | truthfulness | No invented weather, traffic or news | AUTONOMOUS | STALE | yes | 2026-09-20: refusal, 20/20 suite |
| BARGEIN-001 | turn_taking | 闭嘴 stops speech without ending the session | AUTONOMOUS | STALE | no | 2026-09-20: 20/20 suite |
| ECHO-001 | turn_taking | Post-reply cabin echo does not become 「没听清」 | AUTONOMOUS | STALE | yes | 2026-09-21 device 2391ff70 speaker Muted=false; live mic during emulator navi (novavoic… |
...
| NOISE-001 | turn_taking | Room noise does not become a turn | AUTONOMOUS | STALE | yes | 2026-09-20: 20/20 suite |
| SLEEP-001 | turn_taking | 休眠 reaches SLEEP | AUTONOMOUS | STALE | no | 2026-09-20: 20/20 suite |
| UNSUPPORTED-001 | unsupported | A request with no tool is refused, not improvised | AUTONOMOUS | STALE | yes | 2026-09-20, scenario S20 (音量调大): no tool call at all, and the turn ends honestly |
| CAMERA-RELEASE-001 | vision | The camera is released when the app leaves the foreground | AUTONOMOUS | STALE | yes | 2026-09-20: camera CONNECT at 10:20:25 while in the foreground, DISCONNECT at 10:23:27 … |
| VISION-001 | vision | A camera question is answered from the camera | AUTONOMOUS | STALE | yes | 2026-09-20, scenario S19: describe_camera_view is called, or the turn ends without a cl… |
| WAKE-ENGINE-001 | wake_word | MSC engine accepts app-fed audio | AUTONOMOUS | STALE | yes | 2026-09-19: 50 s of app-fed PCM, no error (ACCEPTANCE_TESTS.md) |
...
| WAKE-SYNTH-001 | wake_word | Synthesized 你好小诺 wakes the assistant | AUTONOMOUS | STALE | yes | 2026-09-19 on 2391ff70 |
